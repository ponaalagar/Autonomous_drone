...
def find_safe_landing_spot(frame):
    ...
    # Resize for faster processing (optional, adjust based on laptop performance)
...
def generate_frames():
    """
    Generate frames from the webcam, process them, and yield for streaming.
    """
    while True:
        # Capture frame
        ret, frame = cap.read()
...
def index():
    ...
    <html>
    <head>
        <title>Drone Safe Landing Stream (Laptop Test)</title>
    </head>
    <body>
        <h1>Webcam - Safe Landing Detection Test</h1>
